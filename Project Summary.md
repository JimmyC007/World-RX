...
## Power BI
I used Power Query to process the text-heavy scraped data and organise it into a very granular database (screenshot available in repository). The data was then displayed in a [two page dashboard](https://app.powerbi.com/view?r=eyJrIjoiM2ViNzI3MTQtYjU0OC00ZTljLTkyN2MtMDlhYTFkOGQ3MGY4IiwidCI6IjczZjAyOGRjLTg1ZjItNDg4YS1iZmI1LTIzN2VmN2ZhMjY4YiJ9), page 1 lets the user see in depth data for individual races between 2022 and 2024, and page 2 lets the user compare two drivers head to head in a bunch of different stats.
